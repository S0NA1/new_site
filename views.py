...
from .serializers import AdminsMainSerializer, RoleSerializer, PermissionSerializer, RolePermissionSerializer, ActivityLogSerializer


class AdminsMainViewSet(viewsets.ModelViewSet):
    queryset = AdminsMain.objects.all()
    serializer_class = AdminsMainSerializer
